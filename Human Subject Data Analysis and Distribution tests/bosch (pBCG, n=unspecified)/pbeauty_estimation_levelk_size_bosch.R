...
i=0
  ...
  colnames(output_size)<-c("dataset", "p0","p1","p2","p3","p4","p5","var1", "var2", "var3", "var4", "var5", "n", "treatment","temperature","ci_lower_p0","ci_upper_p0","ci_lower_p1","ci_upper_p1","ci_lower_p2","ci_upper_p2","ci_lower_p3","ci_upper_p3","ci_lower_p4","ci_upper_p4","ci_lower_p5","ci_upper_p5","ci_lower_n","ci_upper_n")
  sf <- 0.0001
  ...
  for (treatment in unique_treatments) {
    ...
    filename_graph <- paste0("BCG_bosch_",treatment, ".pdf")
    ggsave(filename_graph, width = 8, height = 4, units = "in", device = "pdf")
  }
  
filename_table <- paste0("output_BCG_bosch.csv")
