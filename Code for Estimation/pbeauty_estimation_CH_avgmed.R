...
for (treatment in unique_treatments) {
  ...
  output_avgmed[i,10]<-unique(beauty_data$temp)
  n_bootstrap <- 1000
...
#filename_table <- paste0("", llm, "/avgmed/output_avgmed_CH.csv") Choose own directory
...
#combined_filename <- "output_avgmed_CH_allLLMs.csv" Choose own directory
