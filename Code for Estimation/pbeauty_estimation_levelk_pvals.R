...
for (llm in LLMs){
  print(llm)
  filename_data <- paste0("Data files/bcg_1shot_pvals_",llm, ".csv")
  ...
  colnames(output_pvals)<-c("LLM", "p0","p1","p2","p3","p4","p5","var1", "var2", "var3", "var4", "var5", "n", "treatment","temperature","ci_lower_p0","ci_upper_p0","ci_lower_p1","ci_upper_p1","ci_lower_p2","ci_upper_p2","ci_lower_p3","ci_upper_p3","ci_lower_p4","ci_upper_p4","ci_lower_p5","ci_upper_p5","ci_lower_n","ci_upper_n")
  sf <- 0.0001
for (treatment in unique_treatments) {
  ...
  if (unique(beauty_data$p_val)=="twothirds"){
    ...
    output_pvals[i,15]<-unique(beauty_data$temp)
    ...
    # Computing posterior probabilities based on the optimized parameters (not used in current paper)
    ...
    # filename_graph <- paste0("", llm, "/pvals/2+ people/",treatment, ".pdf") Change to directory of your choosing
...
#filename_table <- paste0("/", llm, "/pvals/2+ people/output_pvals.csv") Change to directory of your choosing
...
#combined_filename <- "" Change to directory of your choosing
